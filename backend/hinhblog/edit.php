...
$hb_ma = $_GET['hb_ma'];
$sqlSelect = "SELECT * FROM `hinhblog` WHERE hb_ma=$hb_ma;";

// Thực thi câu truy vấn SQL để lấy về dữ liệu ban đầu của record cần update
$resultSelect = mysqli_query($conn, $sqlSelect);
$hinhblogRow = mysqli_fetch_array($resultSelect, MYSQLI_ASSOC); // 1 record
...
if(isset($_POST['btnSave'])) 
{
    ...
    if (isset($_FILES['hb_tentaptin']))
    {
        ...
        if ($_FILES['hb_tentaptin']['error'] > 0)
        {
            ...
            $old_file = $upload_dir.$hinhblogRow['hb_tentaptin'];
        ...
        // Câu lệnh UPDATE
        $sql = "UPDATE `hinhblog` SET hb_tentaptin='$tentaptin', bl_ma=$bl_ma WHERE hb_ma=$hb_ma;";
...
echo $twig->render('backend/hinhblog/edit.html.twig', [
    'ds_blog' => $dataBlog,
    'hinhblog' => $hinhblogRow,
]);